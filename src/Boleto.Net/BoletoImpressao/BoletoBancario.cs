    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            if (!OcultarEnderecoSacado)
            {
                ...
                /// Autor   Isaac L. 
                /// Data    16/06/2017
                /// Cerbrum Sistemas de Gestão
                /// Alteração para exibir o endereço completo no boleto de forma correta
                /// 

                enderecoSacado += (Sacado.Endereco.End != String.Empty ? "END. " + Sacado.Endereco.End + "<br />, " : "");
                enderecoSacado += (Sacado.Endereco.Bairro != String.Empty ? Sacado.Endereco.Bairro + ", " : "");
                enderecoSacado += (Sacado.Endereco.Cidade != String.Empty ? Sacado.Endereco.Cidade + "" : "");
                enderecoSacado += (Sacado.Endereco.UF != String.Empty ? " / " + Sacado.Endereco.UF + " " : "");
                enderecoSacado += (Sacado.Endereco.CEP != String.Empty ? " - CEP:  " + Sacado.Endereco.CEP + " " : "");

                sacado += enderecoSacado;
